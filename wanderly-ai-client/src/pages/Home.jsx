	...
	return (
		<div className="min-h-screen" style={{ backgroundColor: '#FAF7F2' }}>
			<div className="p-6 max-w-6xl mx-auto">
				...
				{results && (
	              ...
	              />
						...
						<AnimatePresence>
							...
							>
								<h2 className="text-lg font-semibold mb-2" style={{ color: '#1E1E1E' }}>AI Summary</h2>
	                <p className="bg-white border rounded p-3 shadow-sm" style={{ color: '#1E1E1E' }}>
	                  {i18n.language === 'vi'
						...
						<h3 className="mt-6 font-bold" style={{ color: '#1E1E1E' }}>Places</h3>
						<AnimatePresence>
				...
				{isLoading && (
					<div className="mt-6 text-center text-sm" style={{ color: '#1E1E1E' }}>Loading AI results...</div>
				)}
			</div>
		</div>
	);
